    ...
    "schemas": {
      "ArchiveRedirectRequest": {
        ...
        "properties": {
          "project_id":      { "type": "string" },
          "project_name":    { "type": "string" },
          "title":           { "type": "string", "description": "Exact title to match (case-insensitive on server)" },
          "doc_type":        { "type": "string", "enum": ["scene","chapter","concept","character","artifact","location"] },
          "canonical_doc_id":{ "type": "string", "description": "If provided, use this as canonical (strategy becomes explicit)" },
          "strategy":        { "type": "string", "enum": ["newest","oldest","explicit"], "default": "newest" },
          "add_banner":      { "type": "boolean", "default": false, "description": "Prepend an archive banner to duplicate bodies" }
        }
      },
      "UpdateAndArchiveRequest": {
        ...
        "properties": {
          ...
          "title":           { "type": "string" },
          "doc_type":        { "type": "string", "enum": ["scene","chapter","concept","character","artifact","location"] },
          "update_body_md":  { "type": "string", "description": "Body text to replace/append to canonical" },
...
// Aliases for clients calling camelCase endpoints
